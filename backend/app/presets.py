...
EMOJI_PRESETS = [
    ...
    {"emoji": "🤭", "category": "情緒", "ja": "笑い", "zh": "竊笑、含蓄的笑", "en": "Chuckle, giggle"},
    {"emoji": "🥵", "category": "情緒", "ja": "喘ぎ、うめき声", "zh": "喘息、低吟、吃力聲", "en": "Panting, groan"},
    {"emoji": "📢", "category": "音效", "ja": "エコー、リバーブ", "zh": "回音、殘響", "en": "Echo, reverb"},
    {"emoji": "😏", "category": "語氣", "ja": "からかうように、甘えるように", "zh": "調侃、撒嬌", "en": "Teasing, coaxing"},
    {"emoji": "🥺", "category": "情緒", "ja": "声を震わせながら", "zh": "聲音顫抖、不安", "en": "Timid, uncertain"},
    ...
    {"emoji": "🫶", "category": "語氣", "ja": "優しく", "zh": "溫柔地", "en": "Gently"},
    ...
    {"emoji": "⏩", "category": "節奏", "ja": "早口、急いで", "zh": "語速快、急促", "en": "Fast-speaking"},
    {"emoji": "📞", "category": "音效", "ja": "電話越し", "zh": "電話或喇叭質感", "en": "Phone speaker"},
    {"emoji": "🐢", "category": "節奏", "ja": "ゆっくりと", "zh": "慢慢說", "en": "Slowly"},
    {"emoji": "🥤", "category": "音效", "ja": "唾を飲み込む音", "zh": "吞嚥聲", "en": "Gulp"},
    {"emoji": "🤧", "category": "音效", "ja": "咳き込み、鼻をすする", "zh": "咳嗽、吸鼻、噴嚏", "en": "Cough, sniffle"},
    {"emoji": "😒", "category": "語氣", "ja": "舌打ち", "zh": "咋舌、不耐煩", "en": "Tutting"},
    {"emoji": "😰", "category": "情緒", "ja": "慌てて、動揺、緊張", "zh": "慌張、緊張、結巴", "en": "Panicked"},
    {"emoji": "😆", "category": "情緒", "ja": "喜びながら", "zh": "開心地", "en": "Joyfully"},
    {"emoji": "😠", "category": "情緒", "ja": "怒り、不満げに", "zh": "生氣、不滿、鬧彆扭", "en": "Angry"},
    ...
    {"emoji": "🫣", "category": "情緒", "ja": "恥ずかしそうに", "zh": "害羞、難為情", "en": "Shyly"},
